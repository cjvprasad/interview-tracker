...
//     difficulty: "Easy",
//     desc: "Given an array of positive numbers and a positive number 'k', find the maximum sum of any contiguous subarray of size 'k'.",
//     examples: [
//       {
//         input: "[2, 1, 5, 1, 3, 2], k=3",
//         output: "9",
//         explanation: "Subarray [5, 1, 3] gives the maximum sum.",
//       },
//     ],
//     constraints: ["k > 0", "Input array is not empty"],
//     starterCode:
//       "function maxSubArray(k, nums) {\n  // Write your code here\n  return 0;\n}",
//     solution:
//       "function maxSubArray(k, nums) {\n  let maxSum = 0, windowSum = 0, windowStart = 0;\n  for (let windowEnd = 0; windowEnd < nums.length; windowEnd++) {\n    windowSum += nums[windowEnd];\n    if (windowEnd >= k - 1) {\n      maxSum = Math.max(maxSum, windowSum);\n      windowSum -= nums[windowStart];\n      windowStart++;\n    }\n  }\n  return maxSum;\n}",
//     interviewQs: [
//       {
//         q: "Can k be larger than array length?",
//         a: "Usually no, but add a check if needed.",
//       },
//     ],
//   },
...
//   "Pair with Target Sum": {
//     difficulty: "Easy",
//     desc: "Given an array of sorted numbers and a target sum, find a pair in the array whose sum is equal to the given target.",
//     examples: [
//       {
...
//     interviewQs: [
//       { q: "What if array is not sorted?", a: "We can use a Hash Map." },
//     ],
//   },
...
//     interviewQs: [
//       {
//         q: "Can you solve it in O(1) memory?",
//         a: "Yes, Floyd's Cycle Finding Algorithm uses two pointers.",
//       },
//     ],
//   },
...
//   "Merge Intervals": {
//     difficulty: "Medium",
//     desc: "Given an array of intervals where intervals[i] = [start, end], merge all overlapping intervals.",
//     examples: [
//       {
//         input: "[[1,3],[2,6],[8,10],[15,18]]",
//         output: "[[1,6],[8,10],[15,18]]",
...
//     interviewQs: [{ q: "Time complexity?", a: "O(N log N) due to sorting." }],
//   },

//   // --- PATTERN 5: Cyclic Sort ---
//   "Missing Number": {
//     difficulty: "Easy",
//     desc: "Given an array containing n distinct numbers taken from 0, 1, 2, ..., n, find the one that is missing.",
//     examples: [{ input: "[3,0,1]", output: "2" }],
//     constraints: ["n == nums.length"],
//     starterCode: "function missingNumber(nums) {\n  return -1;\n}",
//     solution:
//       "function missingNumber(nums) {\n  let i = 0;\n  const n = nums.length;\n  while (i < n) {\n    const j = nums[i];\n    if (j < n && nums[i] !== nums[j]) {\n      [nums[i], nums[j]] = [nums[j], nums[i]];\n    } else {\n      i++;\n    }\n  }\n  for (i = 0; i < n; i++) {\n    if (nums[i] !== i) return i;\n  }\n  return n;\n}",
//     interviewQs: [{ q: "Can you use XOR?", a: "Yes, XOR indices and values." }],
//   },

//   // --- PATTERN 6: List Reversal ---
//   "Reverse Linked List": {
//     difficulty: "Easy",
...
//         a: "Yes, reverse rest, then flip head.",
//       },
//     ],
//   },
...
//   "Binary Tree Level Order Traversal": {
//     difficulty: "Medium",
//     desc: "Given the root of a binary tree, return the level order traversal of its nodes' values.",
//     examples: [
//       { input: "[3,9,20,null,null,15,7]", output: "[[3],[9,20],[15,7]]" },
//     ],
//     constraints: ["Nodes usually < 2000"],
//     starterCode: "function levelOrder(root) {\n  return [];\n}",
//     solution:
//       "function levelOrder(root) {\n  if (!root) return [];\n  const result = [], queue = [root];\n  while (queue.length) {\n    const levelSize = queue.length;\n    const currentLevel = [];\n    for (let i = 0; i < levelSize; i++) {\n      const node = queue.shift();\n      currentLevel.push(node.val);\n      if (node.left) queue.push(node.left);\n      if (node.right) queue.push(node.right);\n    }\n    result.push(currentLevel);\n  }\n  return result;\n}",
//     interviewQs: [{ q: "Complexity?", a: "O(N) time and O(N) space." }],
//   },

//   // --- PATTERN 8: Tree DFS ---
//   "Path Sum": {
//     difficulty: "Easy",
//     desc: "Return true if the tree has a root-to-leaf path such that adding up all the values equals targetSum.",
...
//     interviewQs: [
//       {
//         q: "Iterative approach?",
//         a: "Use a Stack storing [node, currentSum].",
//       },
//     ],
//   },
...
//   "Find Median from Data Stream": {
//     difficulty: "Hard",
//     desc: "Implement the MedianFinder class: addNum(num) and findMedian().",
//     examples: [
//       {
...
//       "class MedianFinder {\n  constructor() {}\n  addNum(num) {}\n  findMedian() {}\n}",
//     solution:
//       "// JavaScript lacks built-in PriorityQueue\n// Conceptual solution:\n// 1. MaxHeap for lower half\n// 2. MinHeap for upper half\n// 3. Balance sizes so maxHeap has equal or 1 more element",
//     interviewQs: [
//       {
//         q: "Why two heaps?",
//         a: "To access the middle elements in O(1).",
//       },
//     ],
//   },
...
//       },
//     ],
//     constraints: ["Unique numbers"],
//     starterCode: "function subsets(nums) {\n  return [];\n}",
//     solution:
//       "function subsets(nums) {\n  const result = [[]];\n  for (const num of nums) {\n    const n = result.length;\n    for (let i = 0; i < n; i++) {\n      result.push([...result[i], num]);\n    }\n  }\n  return result;\n}",
//     interviewQs: [{ q: "Number of subsets?", a: "2^N" }],
//   },

//   // --- PATTERN 11: Binary Search ---
//   "Binary Search": {
//     difficulty: "Easy",
//     desc: "Given an array of integers nums which is sorted in ascending order, and an integer target, return its index.",
//     examples: [{ input: "nums = [-1,0,3,5,9,12], target = 9", output: "4" }],
//     constraints: ["Sorted, Unique"],
//     starterCode: "function search(nums, target) {\n  return -1;\n}",
//     solution:
//       "function search(nums, target) {\n  let left = 0, right = nums.length - 1;\n  while (left <= right) {\n    const mid = Math.floor(left + (right - left) / 2);\n    if (nums[mid] === target) return mid;\n    if (nums[mid] < target) left = mid + 1;\n    else right = mid - 1;\n  }\n  return -1;\n}",
//     interviewQs: [{ q: "Why l + (r-l)/2?", a: "Prevent integer overflow." }],
//   },
...
//     interviewQs: [
//       {
//         q: "How does XOR work here?",
//         a: "A ^ A = 0. Everything cancels out except the unique one.",
//       },
//     ],
//   },
...
//     solution:
//       "function findKthLargest(nums, k) {\n  // Simple sort approach (O(N log N))\n  // For O(N), use QuickSelect\n  nums.sort((a, b) => b - a);\n  return nums[k - 1];\n}",
//     interviewQs: [{ q: "Best complexity?", a: "O(N) with QuickSelect." }],
//   },

//   // --- PATTERN 14: K-way Merge ---
//   "Merge K Sorted Lists": {
//     difficulty: "Hard",
//     desc: "You are given an array of k linked-lists lists, each linked-list is sorted in ascending order. Merge all.",
//     examples: [
//       { input: "[[1,4,5],[1,3,4],[2,6]]", output: "[1,1,2,3,4,4,5,6]" },
//     ],
//     constraints: ["k lists, N total nodes"],
//     starterCode: "function mergeKLists(lists) {\n  return null;\n}",
//     solution:
//       "// Concept: MinHeap of size k\n// 1. Push head of every list to Heap\n// 2. Pop min, add to result\n// 3. Push next node of popped list to Heap",
//     interviewQs: [{ q: "Time complexity?", a: "O(N log k)" }],
//   },

//   // --- PATTERN 15: 0/1 Knapsack ---
//   "Partition Equal Subset Sum": {
//     difficulty: "Medium",
//     desc: "Given an integer array nums, return true if you can partition the array into two subsets such that the sum of the elements in both subsets is equal.",
//     examples: [{ input: "[1,5,11,5]", output: "true" }],
//     constraints: ["Sum < 20000"],
//     starterCode: "function canPartition(nums) {\n  return false;\n}",
//     solution:
//       "function canPartition(nums) {\n  const sum = nums.reduce((a, b) => a + b, 0);\n  if (sum % 2 !== 0) return false;\n  const target = sum / 2;\n  const dp = new Array(target + 1).fill(false);\n  dp[0] = true;\n  for (let num of nums) {\n    for (let i = target; i >= num; i--) {\n      dp[i] = dp[i] || dp[i - num];\n    }\n  }\n  return dp[target];\n}",
//     interviewQs: [
//       {
//         q: "Why iterate backwards?",
//         a: "To use the 1D array optimization for 0/1 Knapsack.",
//       },
//     ],
//   },

//   // --- PATTERN 16: Unbounded Knapsack ---
//   "Coin Change": {
//     difficulty: "Medium",
//     desc: "Return the fewest number of coins that you need to make up that amount.",
//     examples: [{ input: "coins = [1,2,5], amount = 11", output: "3" }],
//     constraints: ["coins > 0"],
...
//       {
//         q: "Greedy vs DP?",
//         a: "Greedy fails for arbitrary coins (e.g., coins [1,3,4], target 6).",
//       },
//     ],
//   },

//   // --- PATTERN 17: Fibonacci ---
//   "Fibonacci Number": {
//     difficulty: "Easy",
//     desc: "Calculate F(n).",
...
//     solution:
//       "function fib(n) {\n  if (n < 2) return n;\n  let a = 0, b = 1;\n  for (let i = 2; i <= n; i++) {\n    let temp = a + b;\n    a = b;\n    b = temp;\n  }\n  return b;\n}",
//     interviewQs: [{ q: "Complexity?", a: "O(N) time, O(1) space." }],
//   },

//   // --- PATTERN 18: Palindromic Subseq ---
//   "Longest Palindromic Substring": {
//     difficulty: "Medium",
...
//     solution:
//       "function longestPalindrome(s) {\n  let maxStr = '';\n  const expand = (l, r) => {\n    while(l >= 0 && r < s.length && s[l] === s[r]) { l--; r++; }\n    if(r - l - 1 > maxStr.length) maxStr = s.substring(l + 1, r);\n  };\n  for(let i=0; i<s.length; i++) { expand(i, i); expand(i, i+1); }\n  return maxStr;\n}",
//     interviewQs: [
//       { q: "Manacher's Algorithm?", a: "Solves in O(N) but is complex." },
//     ],
//   },
...
//     interviewQs: [
//       {
//         q: "What is Kahn's Algo?",
//         a: "The BFS approach using in-degrees.",
//       },
//     ],
//   },
...
//   "Number of Provinces": {
//     difficulty: "Medium",
//     desc: "Return the total number of provinces (connected components).",
//     examples: [
...
//     examples: [{ input: "insert(apple), search(apple)", output: "true" }],
//     constraints: ["Lower case english"],
//     starterCode:
//       "class Trie {\n  insert(word) {}\n  search(word) {}\n  startsWith(prefix) {}\n}",
//     solution:
//       "class TrieNode { constructor() { this.children = {}; this.isEnd = false; } }\nclass Trie {\n  constructor() { this.root = new TrieNode(); }\n  insert(word) {\n    let node = this.root;\n    for(let c of word) {\n      if(!node.children[c]) node.children[c] = new TrieNode();\n      node = node.children[c];\n    }\n    node.isEnd = true;\n  }\n  // ...search logic similar\n}",
//     interviewQs: [
//       {
//         q: "Space complexity?",
//         a: "O(N * L) where N is words, L is length.",
//       },
//     ],
//   },

//   // --- PATTERN 23: Monotonic Stack ---
//   "Next Greater Element I": {
//     difficulty: "Easy",
//     desc: "Find the next greater element for each element in nums1 based on nums2.",
//     examples: [
//       { input: "nums1=[4,1,2], nums2=[1,3,4,2]", output: "[-1,3,-1]" },
//     ],
//     constraints: ["Subset relationship"],
...
//     interviewQs: [
//       { q: "Why Stack?", a: "To process elements in decreasing order." },
//     ],
//   },
...
//       {
//         q: "DFS vs BFS?",
//         a: "DFS is easier to implement recursively; BFS is better for shortest path.",
//       },
//     ],
//   },
...
//   "N-Queens": {
//     difficulty: "Hard",
//     desc: "Place n queens on an n x n chessboard such that no two queens attack each other.",
//     examples: [{ input: "n = 4", output: "[[.Q..,...]]" }],
//     constraints: ["1 <= n <= 9"],
//     starterCode: "function solveNQueens(n) {\n  return [];\n}",
//     solution:
//       "function solveNQueens(n) {\n  const res = [], board = Array(n).fill('.'.repeat(n));\n  const cols=new Set(), diag1=new Set(), diag2=new Set();\n  function backtrack(r) {\n    if(r===n) { res.push([...board]); return; }\n    for(let c=0; c<n; c++) {\n      if(cols.has(c) || diag1.has(r+c) || diag2.has(r-c)) continue;\n      cols.add(c); diag1.add(r+c); diag2.add(r-c);\n      board[r] = board[r].substring(0,c) + 'Q' + board[r].substring(c+1);\n      backtrack(r+1);\n      board[r] = board[r].substring(0,c) + '.' + board[r].substring(c+1);\n      cols.delete(c); diag1.delete(r+c); diag2.delete(r-c);\n    }\n  }\n  backtrack(0);\n  return res;\n}",
//     interviewQs: [{ q: "Time complexity?", a: "O(N!)." }],
//   },
// };

// Helper to fetch problem (mimics backend)
export const getProblemDetails = (problemName) => {
  if (problemsDB[problemName])
    return { title: problemName, ...problemsDB[problemName] };

  // Fallback Generator
  return {
    title: problemName,
    difficulty: "Medium",
    desc: `<p>Generated details for <strong>${problemName}</strong>.</p>`,
    examples: [],
    constraints: [],
    starterCode: `// Solve ${problemName}\nfunction solve() {\n  return true;\n}`,
    solution: `// Solution for ${problemName}`,
    interviewQs: [],
  };
};
