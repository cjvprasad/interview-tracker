...
const reactQuestionsData = [
  ...
  }, // Q7: Closures
  {
    ...
    explanation:
      "A **closure** is the combination of a function bundled together (enclosed) with references to its surrounding \n\n state (its **lexical environment**).In simple terms, a function forms a closure by retaining access to variables \n\nfrom its parent scope, even after the parent function has finished executing. Closures are powerful for achieving **data privacy** \n\n(encapsulation) and creating **function factories**.\n",
...
const getProblemDetails = (problemName) => {
